...
public class Worlddelete extends PagedMenu {

    private ArrayList<Map> maps;

    public Worlddelete(PlayerGuiData playerGuiData) {
        super(playerGuiData);
    }

    @Override
    public String getGuiName() {
        return "Click to delete world";
    }
    ...
    public void handleGui(InventoryClickEvent e) {
        ...
        if (e.getCurrentItem().getType().equals(Material.PLAYER_HEAD)) {
            ...
            if (!lore.isEmpty()){
                playerGuiData.setMaptoedit(maps.get(index));
    ...
    public void setGuiItems() {
        ...
        if (playerGuiData.getOwner().hasPermission("TittynopeBuild.map.admin")){
